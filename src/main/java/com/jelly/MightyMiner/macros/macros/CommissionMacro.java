...
public class CommissionMacro extends Macro {
    ...
    protected void onEnable() {
        ...
        if (PlayerUtils.getItemInHotbarWithBlackList(true, null, "Juju", "Terminator", "Aurora", "Dragon") == -1) {
            ...
            weaponSlot = PlayerUtils.getItemInHotbar("Juju", "Terminator", "Aurora" , "Dragon");
        }
